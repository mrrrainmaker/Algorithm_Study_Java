...
| :-------- | :---------- | :---- | :--- | :-------- | :-------- |
| 1 초      | 512 MB      | 21089 | 6533 | 5606      | 31.098%   |
...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < l; i++) {
			BigInteger ch = BigInteger.valueOf((str.charAt(i) - 96));
			sum = sum.add(ch.multiply(square(r, i)));
		}
		System.out.println(sum.remainder(mod));
	}
	
	static BigInteger square(BigInteger num, int n) {
		BigInteger answer = new BigInteger("1");
		for (int i = 0; i < n; i++) {
			answer = num.multiply(answer);
		}
		return answer;
	}
}	
